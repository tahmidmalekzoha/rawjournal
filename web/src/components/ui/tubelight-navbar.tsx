...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div
        ref={navRef}
        className="relative flex items-center gap-3 bg-background/5 border border-border backdrop-blur-lg py-1 px-1 rounded-full shadow-lg"
      >
        {/* Sliding lamp indicator */}
        <div
          className="absolute top-0 -translate-y-0 h-full rounded-full bg-white/5 transition-all duration-300 ease-out"
          style={lampStyle}
        >
